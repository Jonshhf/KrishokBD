                    ...
                    <div class="col-sm-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a href="#" class="navbar-brand dam-brand-logo">
                                <img src="assets/images/logo/logo1.png" alt="DAM Logo"
                                ...
                                <div class="d-inline-block d-sm-none">
                                    <div class="d-inline-block">
                                        ...
                                        <input style="display:none;" id='searchBar' name='search' type='search'
                                            placeholder='অনুসন্ধান করুন&hellip;'>
                            ...
                            <div class="collapse navbar-collapse dam-main-manu" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" onclick="online_payment()" data-hover="নোটিশ ">অনলাইন
                                            পেমেন্ট </a>
                                    </li>
                                    </li>
                                    <?php if(isset($_SESSION["user_id"])) { ?>
                                    <li class="nav-item">
                                        <a class="nav-link" onclick="get_profile()" data-hover="আমার প্রোফাইল">আমার
                                            প্রোফাইল</a>
                                    </li>
                                    <?php } ?>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" data-hover="অন্যান্য "
...
".$user_name."
                                   ...
                                   ?>
                                    <span class="header-login-section">
                                        <a class="login btn-sm animated pulse" onclick="login()"><i
                                                class="fas fa-sign-in-alt"></i> লগইন</a>
                                        <a class="signup btn-sm" onclick="registration()"><i
                                                class="fas fa-user-plus"></i> নিবন্ধন করুন</a>
                                    </span>
                                    <?php } ?>
    ...
    <div id="Content" style="min-height: 600px !important;">
        ...
        <aside class="dam-cart-sidebar">
            <div class="cart-header">
                <div class="cart-total"><i class="fas fa-shopping-basket"></i><span class="mr-2">মোট </span> <span
                        class="item_amount_cart2"> </span><span> টি আইটেম</span></div>
        ...
        <main class="main-wrapper bg-light">
            ...
            <div class="container">
                ...
                <div class="cards-wrapper">
                    <div class="card">
                        ...
                        <div class="text">
                            <h3><?php echo $Today_visitor+404; ?> জন</h3>
                            <p>আজকের সেবা গ্রহণীতা</p>
                        </div>
                    </div>
                    <div class="card">
                        <div class="icon"><span class="material-icons">analytics</span></div>
                        <div class="text">
                            <h3><?php echo $Total_visitor+404; ?> জন</h3>
                    ...
                    <div class="card">
                        ...
                        <div class="text">
                            <h3><?php echo $Total_visitor+503; ?> বার</h3>
                            <p>মোট পেজ ভিজিট</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="event-slider">
                                <a href="javascript:void(0)">
                                    <div class="event-inner">
                                        <div class="card-body">
                                            <h4 class="dam-slide-item"
                                                onclick="eventUrl('পোড়াদহ_মেলা_SXAwZ2ZjSkdrTkNMNzZDRWpMZVduZz09')">
                                                পোড়াদহ মেলা </h4>
                                            <small class="event-category d-block"><span
                                                    style="color: #888">বিভাগ-</span> মিষ্টি</small>
                                            <small class="event-date d-block">তারিখ: ২৮ নভেম্বর ২০২৩ - ২৭ নভেম্বর
                                                ২০২৪</small>
                                            <p class="event-page discription">
                                                <span id="des1">
                                                    পোড়াদহ মেলার অন্যতম আকর্ষণ মিষ্টি। রসগোল্লা, সন্দেশ, জিলাপী, নিমকি,
                                                    তিলের নাড়ু, খই, শুকনা মিষ্টি। আরও আকর্ষণীয় হল বড় বড় আকারের
                                                    মিষ্টি। একেকটি মিষ্টি দেড় থেকে দুই কেজি ওজনের হয়ে থাকে।
                                                </span>
                                                <span class="see-more" onclick="OpenDescription(1)">বিস্তারিত
                                                    দেখুন</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="event-inner">
                                        <img src="assets/images/event/1701180296SWxJW.jpg" class="img-fluid"
                                            alt="ফলের মেলা"
                                            onclick="eventUrl('ফলের_মেলা_ZG4waTFKdVd4K2VzdG1iNjRGSXpadz09')">
                                        <div class="card-body">
                                            <h4 class="dam-slide-item"
                                                onclick="eventUrl('ফলের_মেলা_ZG4waTFKdVd4K2VzdG1iNjRGSXpadz09')"> ফলের
                                                মেলা </h4>
                                            <small class="event-category d-block"><span
                                                    style="color: #888">বিভাগ-</span> ফল-ফলাদি</small>
                                            <small class="event-date d-block">তারিখ: ২৮ নভেম্বর ২০২৩ - ২৯ সেপ্টেম্বর
                                                ২০২৫</small>
                                            <p class="event-page discription">
                                                <span id="des2">
                                                    ফলের মেলা উৎসব
                                                </span>
                                                <span class="see-more" onclick="OpenDescription(2)">বিস্তারিত
                                                    দেখুন</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="event-inner">
                                        <img src="assets/images/event/1701251686fJSRp.jpg" class="img-fluid"
                                            alt="মাছের মেলা"
                                            onclick="eventUrl('মাছের_মেলা_QXJZV2FFUnRyK3U0aExrcUJMVkx4QT09')">
                                        <div class="card-body">
                                            <h4 class="dam-slide-item"
                                                onclick="eventUrl('মাছের_মেলা_QXJZV2FFUnRyK3U0aExrcUJMVkx4QT09')"> মাছের
                                                মেলা </h4>
                                            <small class="event-category d-block"><span
                                                    style="color: #888">বিভাগ-</span> মাছ</small>
                                            <small class="event-date d-block">তারিখ: ২৯ নভেম্বর ২০২৩ - ২৮ সেপ্টেম্বর
                                                ২০২৫</small>
                                            <p class="event-page discription">
                                                <span id="des3">
                                                    মাছের মেলায় বিশাল আকারের বাহারি সব মাছের পসরা সাজিয়ে বসে দুই শতাধিক
                                                    মাছ ব্যবসায়ী। এই আয়োজন ঘিরে সেখানে আশপাশের কয়েকটি জেলার মানুষের
                                                    সমাগম হয়। দিনটির জন্য পুরো বছরজুড়ে অপেক্ষায় থাকেন স্থানীয়রা। এদিন
                                                    এলাকার প্রতিটি বাড়ি ভরপুর থাকে অতিথিদের আনাগোনায়। মেলা থেকে মাছ কিনে
                                                    জামাইদের সোজা গন্তব্য শ্বশুরবাড়ি।
                                                </span>
                                                <span class="see-more" onclick="OpenDescription(3)">বিস্তারিত
                                                    দেখুন</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="event-inner">
                                        <img src="assets/images/event/1701347262cinoa.jpg" class="img-fluid"
                                            alt="অর্গানিক মেলা"
                                            onclick="eventUrl('অর্গানিক_মেলা_S09ic0wwaUN0ZDZxYng4YlFZRXM1UT09')">
                                        <div class="card-body">
                                            <h4 class="dam-slide-item"
                                                onclick="eventUrl('অর্গানিক_মেলা_S09ic0wwaUN0ZDZxYng4YlFZRXM1UT09')">
                                                অর্গানিক মেলা </h4>
                                            <small class="event-category d-block"><span
                                                    style="color: #888">বিভাগ-</span> অর্গানিক</small>
                                            <small class="event-date d-block">তারিখ: ৩০ নভেম্বর ২০২৩ - ২৮ সেপ্টেম্বর
                                                ২০২৬</small>
                                            <p class="event-page discription">
                                                <span id="des8">
                                                    অর্গানিক মেলা
                                                </span>
                                                <span class="see-more" onclick="OpenDescription(8)">বিস্তারিত
                                                    দেখুন</span>
                                            </p>
                                        </div>
                                    </div>
            ...
            <!--event details modal -->
            <div class="modal eventDetailsModal" id="eventDetailsModal" tabindex="-1" role="dialog"
                ...
                <div class="col-md-3">
                    ...
                    <div class="app-img d-flex align-items-center pt-2">
                        <a href="#"><img src="https://sadai.gov.bd/frontend/assets/imgs/play-store.png" class="mr-2"
                                alt="Play Store" /></a>
                        <a href="#"><img src="https://sadai.gov.bd/frontend/assets/imgs/apple-store.png"
                                alt="Apple Store" /></a>
                    </div>
                    <div class="social-icons">
                        <a href="https://t.ly/LI6_z" class="social facebook" title="facebook"><i
        ...
        <div class="footer-bottom" style="background-color:#DAF7A6 !important; color:#000000 !important;">
            <div class="container">
                <div class="dam-footer-credit">
                    <center>
                        <p style="color:#000000 !important;">krisokbd.com রেজানুর, সাইফুল ও একদল স্বপ্নবাজ তরুণের
                            সামাজিক উদ্যোগ। আমাদের এই প্রয়াসে যেকোনো ধরনের সহায়তা, পার্টনারশিপ এবং স্পন্সরশিপ কে আমরা
                            স্বাগত জানাই।
                        </p>
                    </center>
    ...
    <!-- footer end -->
    <div class="modal fade" id="authModal" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
        aria-hidden="true">
    ...
    <div id="myModal0" class="modal0">
        ...
        <div class="modal-content0">
            ...
            <h5><b>নীতিমালা<b></h5>
            <hr>
            <p style="font-weight:normal">krisokbd.com একদল স্বপ্নবাজ তরুণের সামাজিক উদ্যোগ। এই উদ্যোগকে হুবহু কপি বা
                তথ্য চুরি করা আইনত দণ্ডনীয় অপরাধ।
                আমাদের দেওয়া প্রতিদিনের তথ্য চুরি করে ব্যবসায়ীক উদ্দেশ্যে অন্য কোন প্লাটফর্মে ব্যবহৃত হলে সেটা আইনত
                দণ্ডনীয় অপরাধ বলেই গণ্য হবে। এই রকম কোন অভিযোগ পাওয়া গেলে নিয়ম অনুযায়ী প্রয়োজনীয় পদক্ষেপ গ্রহণ করতে
                কতৃপক্ষ দৃঢ়ভাবে বদ্ধপরিকর।</p>
        </div>
    ...
    <div id="myModal1" class="modal1">
        ...
        <div class="modal-content1">
            ...
            <h5><b>অভিলক্ষ (Mission)
                    <b></h5>
            <hr>
            <p style="font-weight:normal">• দেশের বিভিন্ন প্রান্তের দৈনিক/ চলমান বাজারদর সম্পর্কে স্বচ্ছ ধারনা রাখা ও
                কৃষিপণ্যের মূল্য সংযোজন কার্যক্রম অব্যাহত রাখা। <br>
                • যে কোন কৃষি পণ্যের পাইকারী বাজারদর সম্পর্কে নাগরিকের তথ্য জানার অধিকার নিশ্চিত করা। <br>
                • স্মার্ট ব্যবস্থাপনার মাধ্যমে মোবাইল ফোনের এক ক্লিকেই সকল কৃষি পণ্যের দৈনিক পাইকারি বাজার দর সম্পর্কে
                জানা।<br>
                • কৃষিপণ্যের এলাকাভিত্তিক সর্বনিম্ন ও সর্বোচ্চ মূল্য একটি মাত্র গ্রাফের মাধ্যমে তথ্য প্রদান করা।<br>
                • কৃষক, ব্যবসায়ী ও ভোক্তার আলাদা প্রফাইলিং এর মাধ্যমে একে অপরের মধ্যে পারস্পরিক বন্ধন তৈরি ও সরাসরি একে
                অপরের সাথে ব্যবসায়ী সম্পর্ক তৈরি করা।<br>
                • মধ্যস্বত্ব ভোগীদের নৈরাজ্য থেকে কৃষক, ব্যবসায়ী ও ভোক্তাকে স্বস্তি প্রদান করা।<br>
                • বাজার অবকাঠামো জোরদারকরণ এবং কৃষিপণ্যের সরবরাহ ব্যবস্থাপনায় সহায়তা প্রদানের মাধ্যমে দক্ষ বাজার
                ব্যবস্থা গড়ে তোলা।<br>
                • উৎপাদক ও বিক্রেতার সাথে ভোক্তার সংযোগ স্থাপনে সহায়তা দান।<br>
                • কৃষি ব্যবসা ও কৃষি ভিত্তিক শিল্প স্থাপনের মাধ্যমে কৃষি ও কৃষিজাত পণ্যের রপ্তানী বৃদ্ধিতে সহায়তা
                করা।<br>
                • কৃষিপণ্যের মূল্য সংযোজন কার্যক্রম অব্যাহত রাখা।<br><br>
                <hr>
                দর্শন (Vision)
                <hr>
                <span style="font-weight:normal">উৎপাদক, বিক্রেতা ও ভোক্তা সহায়ক স্মার্ট কৃষি বিপণন ব্যবস্থা এবং কৃষি
                    ব্যবসা উন্নয়নের মাধ্যমে ব্যক্তি ও জাতীয় অর্থনীতিতে অবদান রাখা।</span>
            </p>
        </div>
    ...
    $(document).ready(function() {
        ...
        function showPosition(position) {
            ...
            var dataString = "latitude=" + latitude + "&longitude=" + longitude + '&siteit=' + siteit +
                '&siteid=' + siteid;
