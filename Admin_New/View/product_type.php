...
<div class="content-wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" >List of Products Type</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$sql = "SELECT a.*,b.name as product_name FROM products_type a,products b where a.product_id=b.id";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    if($row["image_url"]!="")
    {
     ...
     echo "<td class='Productsname'>".$product_name."</td>";
     ...
     echo "<td class='text-center py-0 align-middle' style='text-align:center;'>
                      <div class='btn-group btn-group-sm'>
                        ...
                        <a onclick=deletedata($id,this,'products_type','id') class='btn btn-danger'><i class='fas fa-trash'></i></a>
                      </div>
                    </td>";
     echo "</tr>";
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="Product">Product Type Name</label>
                <input type="text" id="Product" style="width:25%" class="form-control" placeholder="Product Type Name">
              </div>

              <?php

$sqlsem = "SELECT * FROM products where is_active=1";
$resultse = $conn->query($sqlsem);
echo "<select style='width:25%' class='form-control' id='products' name='products' required>";
