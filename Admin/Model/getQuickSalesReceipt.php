...
echo "<td style='width20%;'><img src=$logosrc height='50px' width='50px' style='border-radius:5px;' ></td><td style='width:20%;'></td>
<td style='text-align:center; float:left;'colspan='4'><b><span style='font-size:24px;'>".$companyname."</span><br>".$address."<br>Contact : ".$mobilenoshop."</b></td>";
...
echo "<td style='width:20%'>Customer Name</td>"; 
...
echo "<td style='width:20%'>Customer Address</td>"; 
...
echo "<td style='width:20%'>Mobile No</td>"; 
